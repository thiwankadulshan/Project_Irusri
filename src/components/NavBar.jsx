...
const Navbar = () => {
    ...
    const loggedInUser = useSelector((state) => state.auth.loginUser);
    
    const logOut = ["Log Out", "danger", "/"]
    return (
        <>
            <div className="navbar-main-container">
                <div className="navbar-leftside"onClick={(e) => {navigate(`/account/?loggedInUser=${encodeURIComponent(loggedInUser)}`)}}>
